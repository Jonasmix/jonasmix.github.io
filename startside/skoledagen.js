...
const timeFagU2 = {
    'søndag': ['HELG'],
    mandag: ['Frokost', 'Naturfag', '', 'Matte', 'FRI', 'Gym', '', 'MAF', '', 'Norsk'],
    tirsdag: ['Frokost', 'Gym', '', 'Matte', 'FRI', 'Programmering', '', 'Programmering',],
    onsdag: ['Frokost', 'Samfunn', '', 'KRLE', 'FRI', 'Norsk'],
    torsdag: ['Frokost', 'Engelsk', '', 'Timen Livet', 'FRI', 'MAF', '', 'Natufag'],
